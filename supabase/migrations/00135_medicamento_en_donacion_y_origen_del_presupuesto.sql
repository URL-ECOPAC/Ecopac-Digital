...
COMMENT ON COLUMN donacion_detalle.medicamento_id IS
  ...
  'medicamentos registradas desde la 00135 -lo exige fn_registrar_donacion-, NULL para los otros '
...
COMMENT ON FUNCTION fn_registrar_donacion(UUID, tipo_donacion, DATE, JSONB, UUID, TEXT) IS
  ...
  '{ donacion, detalleIds }, con los ids en el mismo orden que p_detalle. Desde la 00135 '
...
COMMENT ON COLUMN jornada_presupuesto_origen.origen IS
  ...
  'sin_clasificar: el presupuesto que existia antes de la 00135, o el de un INSERT de jornada '

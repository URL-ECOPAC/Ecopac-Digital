#!/usr/bin/env node
// Prueba manual de concurrencia real para numero_ficha (issue #114, migracion 00079).
//
...
// expedientes_numero_ficha_seq (00079) nunca reparte el mismo numero_ficha dos veces.
//

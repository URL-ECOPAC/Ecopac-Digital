#!/usr/bin/env node
// Prueba manual de concurrencia real para numero_ficha (issue #114, migracion 00080).
//
...
// expedientes_numero_ficha_seq (00080) nunca reparte el mismo numero_ficha dos veces.
//

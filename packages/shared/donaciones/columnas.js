...
export const COLUMNAS_DONANTE = [
  { id: "avatar", label: "", tipo: TIPOS_DE_PRESENTACION.AVATAR, desde: "nombre", anchoWeb: "48px" },
  { id: "nombre", label: "Nombre", tipo: TIPOS_DE_PRESENTACION.TEXTO, principal: true },
  { id: "tipo", label: "Tipo", tipo: TIPOS_DE_PRESENTACION.TEXTO, etiquetasDesde: "tiposDeDonante" },
  ...
  { id: "estado", label: "Estado", tipo: TIPOS_DE_PRESENTACION.ESTADO, desde: "activo", etiquetasDesde: "estadoDonante" },
];
...
export const COLUMNAS_DONACION = [
  ...
  { id: "donante", label: "Donante", tipo: TIPOS_DE_PRESENTACION.TEXTO, desde: "donanteNombre", principal: true },
  { id: "tipo", label: "Tipo", tipo: TIPOS_DE_PRESENTACION.TEXTO, etiquetasDesde: "tiposDeDonacion" },

...
//
// Desde la 00134 (issue #840) donacion_detalle guarda medicamento_id: el renglon de una donacion
...
export async function generarIngresoDesdeDonacion(
  ...
  try {
    ...
    const { datos: movimiento, error: errorMovimiento } = await registrarIngreso({
      ...
      bodega_id: bodegaId,
      // Desde la 00134 el renglon ya trae el medicamento del catalogo (issue #840): el ingreso

 ...
 * (RETURNS TABLE, migracion 00078), asi que entrega las columnas tal cual se llaman en
 ...
 * servidor (DEFAULT de expedientes.numero_ficha, migracion 00078) y lo devuelve en la misma
 * llamada.
 *
 * La atomicidad la da fn_registrar_paciente (migraciones 00057, 00078): cualquier violacion
...
// en adelante tiene un formato fijo (6 digitos, migracion 00078), pero la columna sigue sin
...
// aunque lo generado desde la 00078 siempre tenga 6 digitos.

...
export const FILTROS_PROYECTO = [
  { id: "busqueda", tipo: TIPOS_DE_FILTRO.BUSQUEDA, label: "Buscar proyecto", placeholder: "Nombre del proyecto" },
  { id: "estado", tipo: TIPOS_DE_FILTRO.SELECT, label: "Estado", opciones: OPCIONES_ESTADO_PROYECTO },
  { id: "responsableId", tipo: TIPOS_DE_FILTRO.SELECT, label: "Responsable", opcionesDesde: "perfiles" },
];

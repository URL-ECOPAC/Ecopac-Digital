...
| **Integracion** | Vitest contra el stack local real (`pruebas/e2e/`) | El CI | En cada PR que toca `supabase/`, `packages/shared/` o `pruebas/`, y en cada push a `develop` y `main` | Las 41 pruebas de los flujos criticos en verde | Ejecutable |

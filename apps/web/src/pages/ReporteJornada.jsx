  ...
  return (
    <div style={{ padding: "24px", backgroundColor: "#f8fafc", minHeight: "100vh" }}>
      ...
      >
        <div>
          <h1
            style={{ fontSize: "22px", fontWeight: "700", color: "#1e293b", margin: "0 0 8px 0" }}
          >
          ...
          <div style={{ display: "flex", gap: "12px", alignItems: "center", flexWrap: "wrap" }}>
            ...
            <span
              style={{
                ...
                padding: "2px 10px",
                borderRadius: "9999px",
                backgroundColor: estadoEtiqueta.fondo,
                color: estadoEtiqueta.color,
              }}
            >
        ...
        {datos.diagnosticos.map((d, i) => (
          <div
            ...
            style={{
              ...
              alignItems: "center",
              padding: "10px 0",
              borderBottom: i < datos.diagnosticos.length - 1 ? "1px solid #f8fafc" : "none",
            }}
          >
        ...
        {datos.medicamentos.map((m, i) => (
          <div
            ...
            style={{
              ...
              alignItems: "center",
              padding: "10px 0",
              borderBottom: i < datos.medicamentos.length - 1 ? "1px solid #f8fafc" : "none",
            }}
          >
      ...
      <div style={tarjeta}>
        ...
        {datos.personal.map((p, i) => (
          <div
            ...
            style={{
              padding: "12px 0",
              borderBottom: i < datos.personal.length - 1 ? "1px solid #f8fafc" : "none",
            }}
          >
            <div

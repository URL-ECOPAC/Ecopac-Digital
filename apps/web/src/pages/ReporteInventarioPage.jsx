    ...
    <div style={{ padding: "24px", backgroundColor: "#f8fafc", minHeight: "100vh" }}>
      ...
      >
        <div>
          ...
          <p style={{ fontSize: "14px", color: "#64748b", margin: "4px 0 0" }}>
            Existencias por medicamento, lote y bodega
          </p>
        </div>
        <button
      ...
      >
        <Tarjeta
          ...
          valor={totales.unidadesDisponibles}
          color="#10b981"
        />
        <Tarjeta
          etiqueta="Medicamentos Distintos"
          valor={totales.medicamentosDistintos}
          color="#3b82f6"
        />
              ...
              registros.map((r, i) => (
                <tr
                  ...
                  style={{
                    ...
                    backgroundColor: r.estaVencido
                      ? "#fef2f2"
                      : r.medicamento?.activo === false
                        ? "#f8fafc"
                        : "transparent",
                  }}
                >
                  <td style={{ padding: "10px 8px" }}>
                    <div
                      style={{
                        fontWeight: 500,
                        color: r.medicamento?.activo === false ? "#94a3b8" : "inherit",
                      }}
                    >
                    ...
                    <div style={{ fontSize: "12px", color: "#64748b" }}>
                      ...
                      {r.medicamento?.activo === false && (
                        <span style={{ marginLeft: "8px", color: "#9ca3af" }}>— INACTIVO</span>
                      )}
                    </div>
                  </td>
